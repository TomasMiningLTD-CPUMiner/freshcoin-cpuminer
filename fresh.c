...
hashState_sd *     ctx_simd2;
 ...
 memcpy(&ctx, &base_contexts, sizeof(base_contexts));     
	...
	//-------simd512 vect128 -----------------------------
	ctx_simd2=malloc(sizeof(hashState_sd));
	Init(ctx_simd2,512);
	Update(ctx_simd2,(const BitSequence *)hashA,512);
	Final(ctx_simd2,(BitSequence *)hashB);  
	free(ctx_simd2->buffer);
	free(ctx_simd2->A);
	free(ctx_simd2);
	//---echo---
